    ...
    */
    ...
    function buildCalendarHtml(data){
        var rowHtml = _(data.rows).map(function(row){
            ...
            utcInput = !data.showUtcOffset ? '' : '<input class="utcOffset" name="utcOffset" value="' + data.utcOffset + '"/>';
    ...
    _.extend(Calendar.prototype, {
        ...
        _getUserUtcOffset: function(){
            return parseInt(this.$el.find('.utcOffset').val(), 10);
        },
        ...
        render: function(){
            var rowStartDate = this._getStartDate().subtract('days', 1),
                ...
                data = {
                    ...
                    utcOffset: this._getTimezoneUtcOffset(),
